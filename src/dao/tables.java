...
public class tables {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //st.executeUpdate("insert into appuser(userRole,name,mobileNumber,email,password,address,status) values('SuperAdmin','Super Admin','12345','superadmin@testemail.com','admin','SriLanka','Active')");
           ...
           //st.executeUpdate("create table orderDetail (order_pk int AUTO_INCREMENT primary key,orderId varchar(200),customer_fk int,orderDate varchar(200),totalPaid int)");
             st.executeUpdate("create table images (image_pk int AUTO_INCREMENT primary key,product_fk int(50),image BLOB)");
